...
const ProjectsBtn = () => {
  return (
    <div className="mx-auto xl:mx-0">
      <Link
        href={'/work'}
        className="relative w-32 h-32 sm:w-40 sm:h-40 md:w-44 md:h-44 lg:w-48 lg:h-48 xl:w-[185px] xl:h-[185px] flex items-center justify-center group hover:scale-110 transition-all duration-300"
      >
        ...
        <Image
          ...
          width={120}
          height={130}
          className="animate-spin-slow w-3/4 h-3/4 relative z-10"
          style={{
            filter: 'invert(1) grayscale(1) contrast(9999)',
          }}
        />
        <HiArrowRight className="absolute text-lg sm:text-xl md:text-2xl xl:text-3xl text-dark group-hover:translate-x-2 group-hover:text-accent transition-all duration-300 z-20" />
      </Link>
    </div>
  );
};
